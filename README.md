...
|---|---|---|
| **A — Python** | 10 de 17 | 117 ✅ |
| **B — Pandas** | 17 | 3 de ~170 |
| **C — SQL (DuckDB)** | 15 | 3 de ~170 |
| **D — Ponte Pandas ↔ SQL** | 2 | ~40 |

Os módulos A1–A10 estão completos — inclui um módulo de complexidade e Big-O (A9), com exercícios clássicos de entrevista (two-sum, deduplicação O(n), prefix sums, `deque` × `list.pop(0)`) e testes que cronometram a solução, não só conferem o resultado.
...
O verso disso também é verificado: com os esqueletos em branco, **os 123 exercícios reprovam**.
